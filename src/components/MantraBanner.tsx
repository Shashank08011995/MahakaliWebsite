export function MantraBanner() {
  return (
    <section className="bg-white border-b border-gray-200 py-3 overflow-hidden">
      <div className="whitespace-nowrap animate-marquee">
        <span className="text-2xl sm:text-3xl font-devanagari text-sindoor mx-6">
